declare [File] = {Module.link ['Workspace/ctmcp/lib/File.ozf']}

declare
L = {File.readList "Workspace/ctmcp/sec-1.oz"}
{Browse L}

declare
{File.writeOpen 'Workspace/ctmcp/foo.txt'}
...
{Pickle.save [F10Gen1 F10Gen2 FNGen1 FNGen2] 'factfile'}
